...
namespace Taba_Digital.Controllers
{
    public class EmpresaController : Controller
    {
        ...
        public EmpresaController(TabaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id_Empresa,Nome,Email,CNPJ")] Empresa empresa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id_Empresa,Nome,Email,CNPJ")] Empresa empresa)
        {
