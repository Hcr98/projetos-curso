...
namespace Taba_Digital.Controllers
{
    public class PessoaController : Controller
    {
        ...
        public PessoaController(TabaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id_Pessoa,Nome,Email,CPF")] Pessoa pessoa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id_Pessoa,Nome,Email,CPF")] Pessoa pessoa)
        {
